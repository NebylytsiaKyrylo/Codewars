...
const encode = string => string.replace(/[aeiou]/g, x => vowels.indexOf(x) + 1);

const decode = string => string.replace(/[12345]/g, x => vowels[x - 1]);

//OPTION 2

// const encode = string => string.replace(/[aeiou]/g, x => '_aeiou'.indexOf(x));

// const decode = string => string.replace(/[12345]/g, x => '_aeiou'[x]);
