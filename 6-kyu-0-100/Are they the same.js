...
const comp = (a1, a2) =>
  !!a1 &&
  !!a2 &&
  a1.sort((a, b) => a - b).every((v, i) => v == Math.sqrt(a2.sort((a, b) => a - b)[i]));

//OPTION 2
/*
const comp = (a1, a2) =>
  !!a1 && !!a2 && a2.sort().join('') === a1.map(v => v * v).sort().join('');
*/

const a1 = [121, 144, 19, 161, 19, 144, 19, 11];
const a2 = [121, 14641, 20736, 361, 25921, 361, 20736, 361];
const a3 = [121, 144, 19, 161, 19, 144, 19, 11];
const a4 = [132, 14641, 20736, 361, 25921, 361, 20736, 361];
let a5;
const a6 = [132, 14641, 20736, 361, 25921, 361, 20736, 361];

console.log(comp(a1, a2)); // true
console.log(comp(a3, a4)); // false
console.log(comp(a5, a6)); // false
