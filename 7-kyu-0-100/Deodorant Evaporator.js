...
foam or gas lost every day (evap_per_day) and the threshold (threshold)
...
Content is in fact not necessary in the body of the function "evaporator", you can
use it or not use it, as you wish. Some people might prefer to reason with content,
...
function evaporator(content, evapPerDay, threshold) {
  ...
  while (rest > content * (threshold / 100)) {
    rest = rest - rest * (evapPerDay / 100);
    days += 1;
  }
