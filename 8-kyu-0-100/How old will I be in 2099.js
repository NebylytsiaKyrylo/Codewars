...
it was until he would be born, so your function needs to work with both dates in
...
const calculateAge = (y1, y2) =>
  y1 === y2
    ? 'You were born this very year!'
    : y1 < y2
    ? `You are ${y2 - y1} ${y2 - y1 === 1 ? 'year' : 'years'} old.`
    : `You will be born in ${Math.abs(y2 - y1)} ${Math.abs(y2 - y1) === 1 ? 'year' : 'years'}.`;
