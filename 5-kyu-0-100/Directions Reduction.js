...
not much water, it's important to save yourself some energy, otherwise
...
give to the man a simplified version of the plan.
...
function dirReduc(arr) {
  let str = arr.join('');
  let regex = /NORTHSOUTH|SOUTHNORTH|EASTWEST|WESTEAST/;

  while (regex.test(str)) {
    str = str.replace(regex, '');
  }
  return str.match(/WEST|EAST|NORTH|SOUTH/g) || [];
}
*/
