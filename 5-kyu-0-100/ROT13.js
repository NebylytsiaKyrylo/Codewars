...
(http://en.wikipedia.org/wiki/ROT13) is frequently used
to obfuscate jokes on USENET.
...
const rot13 = str =>
  str.replace(/[a-z]/gi, x => String.fromCharCode(x.charCodeAt() + (x.toLowerCase() <= 'm' ? 13 : -13)));
